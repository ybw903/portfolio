        ...
        <article className="projects">
            <div className="projects-content">
                <div className="section-title">
                    <div className = "section-title-text" style={{color:'#ffffff',borderBottomColor:'#cccccc'}}>Archiving</div>
                </div>
                ...
                <div className="projects-project">
                    ...
                    <div className="projects-info">
                        ...
                        <div className="projects-descriptions">
                            <div className="projects-main-description">
                                졸업프로젝트로 인근에 위치한 주차장 정보 조회 및 구현한 차량번호 인식 주차시스템 예약 시스템을 구현하였습니다.
